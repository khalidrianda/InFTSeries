...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url('home'); ?>" class="logo">
      ...
      <span class="logo-mini"><b>IF</b>TS</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">InFTSeries</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url('assets/img/profile/').$user['image']; ?>" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo $user['name']; ?>
                  <small>Member since <?php echo date('d F Y', $user['date_created']); ?></small>
                </p>
              </li>
