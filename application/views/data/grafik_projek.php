                ...
                <div class="dataTable_wrapper">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example5">
                        <thead>
                            ...
                            <th width="90"><center>Tipe Peramalan</center></th>
                            <th width="50"><center>Tipe Data</center></th>
                            <th width="80"><center>Lihat Grafik</center></th>
                        </thead>
                        <tbody>
                            <?php 
                            $no =1;
                        ...
                        <tr>
                           <td><center><?php echo $no++ ?></center></td>
                            ...
                            <?php else : ?>
                            <td><center><?php echo anchor('fungsi/detail/'.$pjk->id.'/'.$title.'/'.$pjk->tipe, '<div class="btn btn-primary btn-sm"><i class="fa fa-line-chart"></i></div>'); ?></center></td>
                            <?php endif; ?>
                            </center></td>
                        </tr>
                            <?php endforeach; ?>
