												...
												<tbody>
													<?php
														...
														while($data = mysql_fetch_array($qry2)){
															...
															$tampung[] = $temp_bulan;
															$search = $tempjum;
															$testt = getClosest($search, $arr_near);
															$jumlah =  $testt;
															$simpan=1;
															...
															for($i; $i<$lima; $i++){
																...
																$jumla[] = $jumlah;
																$index_arr = array_search($testt, $arr_near);	
															if($index_arr !== false && $index_arr < count($arr_near)-1 && $arr_near[$index_arr+$simpan]!=null) $next = $arr_near[$index_arr+$simpan];
													   		else $next = $arr_near[0]; $testt=$arr_near[0];
																$search = $ramalan;
